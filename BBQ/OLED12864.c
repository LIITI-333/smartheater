...
void OLED_Init(void)
{
	...
	OLED_WrCmd(0xa1);//--Set SEG/Column Mapping     0xa0׳Ӓ·´փ 0xa1ս³£
	OLED_WrCmd(0xc8);//Set COM/Row Scan Direction   0xc0ɏς·´փ 0xc8ս³£
